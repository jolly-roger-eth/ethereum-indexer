...
- `processorCodeFingerprint(processor)` and `assertProcessorVersion(processor, implementation)` are exported from `ethereum-indexer` for anyone implementing their own `EventProcessor`.
