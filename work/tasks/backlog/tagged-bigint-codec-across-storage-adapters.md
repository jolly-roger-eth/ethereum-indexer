...
- [ ] One codec in the core, used by the CLI, both browser adapters, the fs adapter, `db-utils`, and `@etherfold/processor-sqlite`. No package keeps a private BigInt encoder or decoder.
